 ...
 */
export const getRecommendedFee = ({ coin = "sprint", transactionSize = 256 } = {}) => (dispatch) => {
...
export const sendTransaction = ({ txHex = "", selectedCrypto = "sprint", sendTransactionFallback = true } = {}) => (dispatch) => {
	return new Promise(async (resolve) => {
		const failure = (data = "") => {
